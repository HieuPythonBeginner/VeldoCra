...
private:
    ...
    void initialize_static_keywords() {
        // Standard C++ keywords
        static_keywords_.emplace_back("var", TokenType::Kw_Let, KeywordCategory::Declaration);
        ...
        static_keywords_.emplace_back("self", TokenType::Identifier, KeywordCategory::OOP);
        static_keywords_.emplace_back("this", TokenType::Identifier, KeywordCategory::OOP);
        
        // Legacy flow control and declaration keywords (always enabled)
        ...
        static_keywords_.emplace_back("break", TokenType::Kw_Break, KeywordCategory::FlowControl);
        static_keywords_.emplace_back("continue", TokenType::Kw_Continue, KeywordCategory::FlowControl);
        static_keywords_.emplace_back("pass", TokenType::Kw_Pass, KeywordCategory::FlowControl);
        
        static_keywords_.emplace_back("new", TokenType::Kw_Manifest, KeywordCategory::Memory);
        static_keywords_.emplace_back("manifest", TokenType::Kw_Manifest, KeywordCategory::Memory);
        static_keywords_.emplace_back("delete", TokenType::Kw_Ee, KeywordCategory::Memory);
        ...
        static_keywords_.emplace_back("extern", TokenType::Kw_Extern, KeywordCategory::Module);
        ...
        static_keywords_.emplace_back("scribe", TokenType::Kw_Scribe, KeywordCategory::Function);
        
        // Phase 7: Memory keywords (partial - rest in .veldan files)
        ...
        // Phase 7: System command keywords
        ...
        static_keywords_.emplace_back("nonlinear", TokenType::Kw_NonLinear, KeywordCategory::Function);
        static_keywords_.emplace_back("wait", TokenType::Kw_Wait, KeywordCategory::Function);
        
        // Phase 7: OOP variants
