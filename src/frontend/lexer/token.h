...
enum class TokenType : uint16_t {
    ...
    Kw_None,
    Kw_Extern,      // extern
    Kw_Transpile,   // @transpile directive
    
    // Phase 7 Keywords (minimal set)
    Kw_Manifest,    // var/new
    Kw_Verdict,     // if
    Kw_Fail,        // else
    Kw_Faildict,    // elif
    ...
    // Phase 7 additional keywords
    Kw_Origin,      // origin (system/asm mode)
    Kw_Clm,         // memory op: reclaim
    Kw_Rsz,         // memory op: resize
 ...
 * Use veldanava::lexer::KeywordTable::lookup() for keyword lookups
 * Use veldanava::lexer::KeywordCategoryLookup for category-based dispatch
 * 
