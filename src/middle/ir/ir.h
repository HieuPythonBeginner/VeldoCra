...
public:
    ...
    IRInstruction* create_gep(IRValue* base, IRValue* index, Type* result_type);
...
public:
    ...
    IRModule* generate(veldanava::ast::Node* root);
...
private:
    ...
    // Visit methods
    IRValue* visit(veldanava::ast::Node* node);
    IRValue* visit_literal(veldanava::ast::LiteralExprNode* node);
    IRValue* visit_variable(veldanava::ast::VariableExprNode* node);
    IRValue* visit_binary(veldanava::ast::BinaryExprNode* node);
    IRValue* visit_call(veldanava::ast::CallExprNode* node);
};
